...
!LPP  REAL(r_size),PARAMETER :: sigma_obs=5.0d0 ! grids
!LPP  REAL(r_size),PARAMETER :: sigma_obs=3.0d0 ! grids
!LPP  REAL(r_size),PARAMETER :: sigma_obs=10.0d0  ! grids - letkf000_10
!LPP  REAL(r_size),PARAMETER :: sigma_obs=30.0d0  ! grids - letkf030_10
!Leo  REAL(r_size),PARAMETER :: sigma_obs=30.0d0   ! grids - letkf030_10
  REAL(r_size),PARAMETER :: sigma_obs=3.0d0
  REAL(r_size),PARAMETER :: sigma_obsv=100.0d0 ! meters
