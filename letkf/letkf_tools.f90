...
! Leo REAL(r_size),PARAMETER :: cov_infl_mul = 1.20d0 !multiplicative inflation
...
WRITE(*,*),'sigma_obs ---- Leo',sigma_obs ! Leo
WRITE(*,*),'sigma_obsv ---- Leo',sigma_obsv ! Leo
